    ...
    return (
      <div className="bg-gray-50 rounded-lg p-6 text-center">
        <p className="text-gray-600">
          Your referral code is being generated. Please check back later.
        </p>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-lg shadow-lg p-6 space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 text-sm">
          Generate a personalized donation link to share with friends and family
        </p>
      </div>

      {/* Your Referral Code Display */}
      <div className="bg-amber-50 rounded-lg p-4 text-center">
        <p className="text-sm text-amber-700 mb-1">Your Referral Code</p>
      ...
      <div className="border border-gray-200 rounded-lg p-4">
        <h4 className="font-semibold text-gray-800 mb-2">Simple Link</h4>
      ...
      <div className="border border-amber-200 rounded-lg p-4 bg-amber-50/50">
        <h4 className="font-semibold text-amber-900 mb-4">Customize Your Link</h4>
      ...
      <p className="text-xs text-gray-500 text-center">
        Donations made through your link will be attributed to you on the collector leaderboard.
      </p>
    </div>
  );
};
