...
const CollectorStatusCard = ({ 
      ...
      <div className={`bg-white rounded-xl shadow-md p-6 border border-gray-100 ${className}`}>
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6 text-sm">
            Apply to become a verified collector and help us spread awareness for donations.
          </p>
          <Link
            to="/collector/apply"
  ...
  if (role === "COLLECTOR_PENDING" || status === "pending") {
    return (
      <div className={`bg-white rounded-xl shadow-md p-6 border border-yellow-200 ${className}`}>
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-sm">
              Your collector application has been submitted and is currently under review. 
              We will notify you once the verification is complete.
            </p>
            {collectorProfile?.submittedAt && (
              <p className="text-gray-500 text-xs mt-3">
                Submitted on {new Date(collectorProfile.submittedAt).toLocaleDateString("en-IN", {
                  day: "numeric",
                  month: "long",
                  year: "numeric",
                })}
  ...
  if (role === "COLLECTOR_APPROVED" || status === "approved") {
    return (
      <div className={`bg-white rounded-xl shadow-md p-6 border border-green-200 ${className}`}>
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              <h3 className="text-lg font-semibold text-gray-900">Verified Collector</h3>
            ...
            <p className="text-gray-600 text-sm mb-4">
              ...
              You can now access the collector dashboard and share referral links.
            </p>
            <Link
              to="/collector"
  ...
  if (status === "rejected") {
    return (
      <div className={`bg-white rounded-xl shadow-md p-6 border border-red-200 ${className}`}>
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-sm mb-2">
              Unfortunately, your collector application was not approved.
            </p>
