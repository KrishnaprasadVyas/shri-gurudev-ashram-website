...
const Navbar = ({ showAnnouncement = false, announcements = [] }) => {
  ...
  return (
    <nav ref={navRef} className={`fixed left-0 right-0 z-50 bg-amber-50/95 backdrop-blur-sm shadow-lg transition-transform duration-300 ${
          ...
          <div className="flex justify-between items-center h-10 py-2">
            ...
            <div className="flex items-center space-x-2">
              <a
                ...
                aria-label="Facebook"
              >
                <svg className="w-4 h-4 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-amber-50/95">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Logo & Navigation - Centered Layout */}
          <div className="flex justify-center items-center h-20 lg:h-24 relative">
            {/* Desktop Navigation - Left Side */}
            <div className="hidden lg:flex items-center space-x-1 flex-1 justify-end pr-8">
          ...
          <div className="flex-shrink-0">
            ...
            <div className="hidden lg:flex items-center space-x-1 flex-1 justify-start pl-8">
            ...
            <button
              ...
              className="lg:hidden absolute right-0 p-2 rounded-md text-gray-600 hover:bg-amber-100 transition-colors"
